...
| 状態 | 試験ID | 根拠または残作業 |
| --- | --- | --- |
| 証跡あり | `REL-001`、`REL-005`〜`REL-007`、`REL-009`、`REL-011`〜`REL-020`、`REL-023`〜`REL-027` | 第3節の自動検査、静的レビュー、外部送信照合および署名証明書照合 |
| 一部確認 | `REL-002`〜`REL-004`、`REL-021`、`REL-022` | テストや成果物は存在するが、項目が要求するレビュー・実機条件・外部突合・commit対応の一部が未記録 |

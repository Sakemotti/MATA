...
- 文書状態: 確定
- 最終更新日: 2026-08-10
- 関連仕様: [開発ガイドライン](../development-guidelines.md)、[起動の性能・試験仕様](../startup-specs/performance-and-testing.md)、[データモデル仕様](../domain-specs/data-model.md)、[通知仕様](../notification-specs/README.md)、[ウィジェット仕様](../widget-specs/README.md)

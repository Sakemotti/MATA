...
- 文書状態: 確定
- 最終更新日: 2026-08-10
- 関連仕様: [アプリ全体仕様](../app-spec.md)、[開発ガイドライン](../development-guidelines.md)、[総合動作確認項目書](../test-specs/README.md)、[収益化仕様](../monetization-specs/README.md)、[セキュリティ・プライバシー仕様](../security-privacy-specs/README.md)、[ログ・診断・品質監視仕様](../observability-specs/README.md)

...
初回リリース候補に対する実行証跡と残項目は[初回リリース試験棚卸し](initial-release-inventory.md)、403件の項目別結果は[リリース別試験結果の管理](results-management.md)、担当は[初回リリース試験担当割り当て](closed-testing-assignments.md)、Closed testingの参加・端末・実施結果は[初回Closed testing実施台帳](closed-testing-log.md)へ記録する。テスターへの案内には[MATA Closed testing参加ガイド](closed-testing-tester-guide.md)を使用する。

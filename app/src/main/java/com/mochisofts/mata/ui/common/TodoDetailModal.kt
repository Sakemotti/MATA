...
data class TodoDetailModalData(
    ...
    val fields: List<TodoDetailField> = emptyList(),
    val sections: List<TodoDetailSection> = emptyList(),
)
    ...
    Column {
        TopAppBar(
            ...
            colors = TopAppBarDefaults.topAppBarColors(
                ...
                scrolledContainerColor = MaterialTheme.mataPageColor,
            ),
        )
        HorizontalDivider()
    }
...
private fun TodoDetailContent(
    ...
    Column(
        ...
        data.sections.filter { it.fields.isNotEmpty() }.forEach { section ->

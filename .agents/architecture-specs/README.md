...
- 文書状態: 確定
- 最終更新日: 2026-08-10
- 関連仕様: [開発ガイドライン](../development-guidelines.md)、[ドメイン仕様](../domain-specs/README.md)、[全画面仕様](../screen-specs/README.md)、[エラー処理・障害回復仕様](../error-handling-specs/README.md)、[性能・省電力仕様](../performance-specs/README.md)

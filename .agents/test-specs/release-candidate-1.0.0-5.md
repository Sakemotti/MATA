...
| ソースブランチ | クリーンな`main` |
| ビルド日時 | `2026-09-13T06:09:19.500058700Z` |
...
| --- | --- | ---: | --- |
| Android App Bundle | `mata-1.0.0-5.aab` | 12,673,367 | `888272618220628cefdef448f4f96bc28d01f7f22eea6b6b64757a34e64e2ad9` |
...
| CycloneDX SBOM | `release-sbom.cdx.json` | 605,847 | `935196a25832bd5ad427eefcd4dbc183311aa0733a7e0aefb6ac3e8b7528a644` |
...
- CI: [PR #194のrun 34741198020](https://github.com/Sakemotti/MATA/actions/runs/34741198020)と[PR #195のrun 34741651049](https://github.com/Sakemotti/MATA/actions/runs/34741651049)でRepository security、Debug、Release、Performance APKおよびAPI 30 instrumented testが成功。
...
主要な画面変更は[PR #193](https://github.com/Sakemotti/MATA/pull/193)と[PR #194](https://github.com/Sakemotti/MATA/pull/194)、versionCode更新は[PR #195](https://github.com/Sakemotti/MATA/pull/195)で統合した。

...
本書は、2026年8月28日時点のRelease構成をGoogle Play ConsoleのData safetyフォームへ転記するための申請案である。MATA本体だけでなく、GMA Next-Gen SDK 1.4.0、UMP 4.0.0、Google Play Billing 9.1.0およびHolidays JPへの通信を含む。

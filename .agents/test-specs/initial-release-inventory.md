...
2026年9月16日時点では、項目単位の証跡が揃ったP0を247件、P1を157件`合格`、P0/P1の残り1件を`未実施`として登録した。P2を含む全423件では407件が合格、16件が未実施である。今回はフォント倍率200%・320×640dpのコンパクト表示で、設定画面の全内容、説明、現在値、スイッチ、バックアップ、復元および広告プライバシー設定へ到達・操作できることを追加合格とした。
...
| 一部確認 | なし | - |
| 未完了 | `REL-010` | 全P0/P1の合格結果を集計し、最終公開可否を判定する |
